...
<!-- end custom head snippets -->
  ...
  <script src="blob:https://cagribolat.github.io/2edaba31-b8af-4746-85ab-88046e5dc481"></script><style type="text/css" id="operaUserStyle"></style></head>
  <body>
    ...
    <style>
        ...
        body {
            ...
            margin-top: 0; /* İçeriği en üste taşı */
        }
        .container-lg {
            max-width: 960px;
            margin: 20px auto;
